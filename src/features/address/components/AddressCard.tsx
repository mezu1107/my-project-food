...
export const AddressCard = ({
  ...
  // Safe fallback for icon if label is unexpected
          ...
          <div className="flex-1 min-w-0">
            ...
            {address.area ? (
              <p className="text-xs text-muted-foreground">
                {address.area.name || 'Unknown Area'}
                {address.area.city ? `, ${address.area.city}` : ''}
              </p>
            ) : (
              <p className="text-xs text-muted-foreground">Area not specified</p>
            )}
