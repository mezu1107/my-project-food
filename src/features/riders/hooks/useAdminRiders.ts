...
export function useAdminRiders(params?: {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      return await apiClient.get<AdminRidersResponse>('/admin/riders', {
        params: {
...
export function useRiderStats() {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await apiClient.get<RiderStatsResponse>('/admin/riders/stats');
...
export function useAdminRider(id: string | undefined) {
  return useQuery({
    ...
    enabled: !!id,
    queryFn: async () => {
      const response = await apiClient.get<SingleRiderResponse>(`/admin/riders/${id}`);
...
export function useBlockedRiders(page = 1, limit = 20) {
  return useQuery({
    ...
    queryFn: async () => {
      return await apiClient.get<AdminRidersResponse>('/admin/riders/blocked', {
        params: { page, limit },
      });
    },
  });
...
export function usePermanentlyBannedRiders(page = 1, limit = 20) {
  return useQuery({
    ...
    queryFn: async () => {
      return await apiClient.get<AdminRidersResponse>('/admin/riders/permanently-banned', {
        params: { page, limit },
      });
    },
  });
...
export function useAvailableRidersForAssignment() {
  return useQuery({
    queryKey: ['admin', 'riders', 'available-for-assignment'],
    queryFn: async () => {
      const response = await apiClient.get<{ success: true; riders: AdminRider[] }>('/admin/riders/available');
...
export function useUpdateRiderStatus() {
  ...
  return useMutation({
    mutationFn: async ({ id, riderStatus }: { id: string; riderStatus: 'pending' | 'approved' | 'rejected' }) => {
      return await apiClient.patch<AdminActionResponse>(`/admin/riders/${id}/status`, { riderStatus });
    },
    onSuccess: (data) => {
...
export function useApproveRider() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return await apiClient.patch<AdminActionResponse>(`/admin/riders/${id}/approve`);
    },
    onSuccess: (data) => {
      qc.invalidateQueries({ queryKey: ['admin', 'riders'] });
      toast.success(data.message);
...
export function useRejectRider() {
  ...
  return useMutation({
    mutationFn: async ({ id, reason }: { id: string; reason: string }) => {
      return await apiClient.patch<AdminActionResponse>(`/admin/riders/${id}/reject`, { reason });
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['admin', 'riders'] });
...
export function usePromoteToRider() {
  ...
  return useMutation({
    mutationFn: async ({ id, riderDocuments }: { id: string; riderDocuments?: Partial<RiderDocuments> }) => {
      return await apiClient.post<AdminActionResponse>(`/admin/riders/${id}/promote-to-rider`, riderDocuments || {});
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['admin', 'riders'] });
...
export function useBlockRider() {
  ...
  return useMutation({
    mutationFn: async ({ id, reason }: { id: string; reason: string }) => {
      return await apiClient.patch<AdminActionResponse>(`/admin/riders/${id}/block`, { reason });
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['admin', 'riders'] });
...
export function useUnblockRider() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return await apiClient.patch<AdminActionResponse>(`/admin/riders/${id}/unblock`);
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['admin', 'riders'] });
...
export function useSoftDeleteRider() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return await apiClient.delete<AdminActionResponse>(`/admin/riders/${id}/soft-delete`);
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['admin', 'riders'] });
...
export function useRestoreRider() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return await apiClient.patch<AdminActionResponse>(`/admin/riders/${id}/restore`);
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['admin', 'riders'] });
...
export function usePermanentlyBanRider() {
  ...
  return useMutation({
    mutationFn: async ({ id, reason }: { id: string; reason: string }) => {
      return await apiClient.post<AdminActionResponse>(`/admin/riders/${id}/permanent-ban`, { reason });
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['admin', 'riders'] });
...
export function useAdminAssignRider() {
  ...
  return useMutation({
    mutationFn: async ({ orderId, riderId }: { orderId: string; riderId: string }) => {
      return await apiClient.patch<AdminActionResponse>(`/admin/riders/${orderId}/assign-rider`, { riderId });
    },
    onSuccess: (data) => {
